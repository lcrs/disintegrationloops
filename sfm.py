...
CAMERA_SENSOR_WIDTH_DIRECTORY = "/works/disintegrationloops/openmvg/openMVG/src/software/SfM" + "/../../openMVG/exif/sensor_width_database"
...
pIntrisics = subprocess.Popen( [os.path.join(OPENMVG_SFM_BIN, "openMVG_main_SfMInit_ImageListing"),  "-i", input_dir, "-o", matches_dir, "-d", camera_file_params, "-f", "1024"] )
pIntrisics.wait()
